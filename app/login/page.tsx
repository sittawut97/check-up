...
//     <div className="min-h-screen bg-[#002D56] flex items-center justify-center p-4">
//       <div className="max-w-4xl w-full">
//         <div className="text-center mb-12">
//           <h1 className="text-5xl font-bold text-white mb-4">ยินดีต้อนรับ</h1>
//           <p className="text-xl text-blue-100">กรุณาเลือกประเภทการเข้าสู่ระบบ</p>
//         </div>
...
//           <Link
//             href="/login/customer"
//             className="bg-white rounded-3xl p-8 shadow-2xl hover:shadow-3xl transform hover:scale-105 transition duration-300 text-left group cursor-pointer block"
//           >
//             <div className="flex items-center justify-center w-20 h-20 bg-blue-100 rounded-2xl mb-6 group-hover:bg-blue-200 transition">
//               <User className="w-10 h-10 text-blue-600" />
//             </div>
//             <h2 className="text-2xl font-bold text-gray-800 mb-3">ผู้มาใช้บริการ</h2>
//             <p className="text-gray-600 mb-4">
//               สำหรับลูกค้าและผู้ใช้งานทั่วไป เข้าสู่ระบบเพื่อใช้บริการต่างๆ
//             </p>
...
//             className="bg-white rounded-3xl p-8 shadow-2xl hover:shadow-3xl transform hover:scale-105 transition duration-300 text-left group cursor-pointer block"
//           >
//             <div className="flex items-center justify-center w-20 h-20 bg-emerald-100 rounded-2xl mb-6 group-hover:bg-emerald-200 transition">
//               <Briefcase className="w-10 h-10 text-emerald-600" />
//             </div>
//             <h2 className="text-2xl font-bold text-gray-800 mb-3">พนักงาน</h2>
//             <p className="text-gray-600 mb-4">
//               สำหรับพนักงานและผู้ดูแลระบบ เข้าสู่ระบบจัดการภายใน
//             </p>
